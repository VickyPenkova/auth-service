...
import static com.cogent.authservice.constants.MicroServiceConstants.PATIENT_MICROSERVICE;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers("/index", "/login", "/authenticate").permitAll()
                .anyRequest().authenticated()
                .antMatchers(DOCTOR_MICROSERVICE+"/*").hasRole("DOCTOR")
                .antMatchers(PATIENT_MICROSERVICE+"/*").hasRole("PATIENT")
                .and()
